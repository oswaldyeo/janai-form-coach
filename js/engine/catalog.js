...
export const MUSCLES = ['chest', 'back', 'shoulders', 'triceps', 'biceps', 'quads', 'hamstrings', 'glutes', 'calves', 'core'];
export const EQUIPMENT = ['barbell', 'dumbbell', 'cable', 'machine', 'bodyweight', 'kettlebell'];
export const CATEGORIES = ['push', 'pull', 'legs', 'core'];

const CATALOG = [
  // ── v1 lifts (bodyweight + dumbbell) ──────────────────────────────────────
  {
    id: 'squat', name: 'Squat (bodyweight)', category: 'legs', equipment: 'bodyweight',
  ...
  {
    id: 'pushup', name: 'Push-up', category: 'push', equipment: 'bodyweight',
  ...
  {
    id: 'lunge', name: 'Alternating lunge', category: 'legs', equipment: 'bodyweight',
  ...
  // ── requested new camera lifts ────────────────────────────────────────────
  {
    ...
    primaryMuscle: 'quads', secondaryMuscles: ['glutes', 'core'],
    loadType: 'external', unilateral: false, defaultRestSec: 120,
  ...
  {
    id: 'triceps-pushdown', name: 'Triceps pushdown', category: 'push', equipment: 'cable',
    primaryMuscle: 'triceps', secondaryMuscles: [],
    loadType: 'external', unilateral: false, defaultRestSec: 90,
  ...
  {
    id: 'cable-twist', name: 'Cable twist / woodchop', category: 'core', equipment: 'cable',
  ...
  },
  {
    ...
    primaryMuscle: 'back', secondaryMuscles: ['hamstrings', 'glutes', 'quads'],
    loadType: 'external', unilateral: false, defaultRestSec: 180, camera: null,
  },
  {
  ...
  {
    id: 'plank', name: 'Plank (hold)', category: 'core', equipment: 'bodyweight',
    primaryMuscle: 'core', secondaryMuscles: ['shoulders'],
